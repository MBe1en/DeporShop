...
function Header() {
  return (
    <>
     {/* bg-blue-ribbon-600 font-semibold  */}
      {/* <header className="h-32 w-full bg-slate-900 rounded-b-3xl shadow-lg shadow-slate-800 flex items-center justify-between px-8 flex-wrap"> */}
